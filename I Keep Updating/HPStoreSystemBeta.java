...
class HPStoreSystemBeta
{
        ...
        if(search == 1)
        {
          ...
          for(i=0; i < clients.length; i++)
          {
            try
            {
              ...
              {
                  total = total + clients[i].getNotePrice(2);
              }
            }
            catch(NullPointerException e)
            {
  ...
  public static void printing(Client clients[], Product products[], int i) throws IOException
  {
    ...
    writeFile.println("                                                             -----------------");
    writeFile.println("Subtotal                                                     $" + clients[i].getNotePrice(0));
    writeFile.println("IVA                                                          $" + clients[i].getNotePrice(1));
    writeFile.println("Total                                                        $" + clients[i].getNotePrice(2));
    writeFile.println();
    writeFile.println();
