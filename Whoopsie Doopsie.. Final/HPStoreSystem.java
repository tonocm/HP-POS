 ...
 * This program is a stand-alone platform to perform inventory and financial tasks in a small business.
 * The program consists of an application class (this one) and two object classes that compliment the program's functionality.
 * This program offers the user the following abilities: handle inventories, handle client databases, perform statistics, generate store invoices, supports several users
 * The program was specifically coded for the use of HP Store and it wa focused on its needs as small business
 * November 22, 2012
 * 002267 - 006
 **/
class HPStoreSystem
{
  public static void main (String[] args) throws IOException //Main Method, holds the Menu and links all the sub-methods
  {
  ...
  //Methods:
  public static boolean verifyLogin(String username, String password) //Verifies Login Information (Username/Password)
  {
    boolean test = false;
  ...
  public static void searchClient(Client clients[]) throws IOException //Searches Specific Client by Name
  {
    PrintWriter stdOut = new PrintWriter(System.out, true);
    BufferedReader stdIn = new BufferedReader(new InputStreamReader(System.in));
  ...
  public static void statistics(String username, int option, Client clients[]) throws IOException //Generate Statistics for Users
  {
    PrintWriter stdOut = new PrintWriter(System.out, true);
    BufferedReader stdIn = new BufferedReader(new InputStreamReader(System.in));
  ...
  public static void searchProduct(Product products[]) throws IOException //Searches Products by ID Number
  {
    PrintWriter stdOut = new PrintWriter(System.out, true);
    BufferedReader stdIn = new BufferedReader(new InputStreamReader(System.in));
  ...
  public static void inventory(int option, Product products[]) throws IOException //Handles the Inventory Completely
  {
    PrintWriter stdOut = new PrintWriter(System.out, true);
    BufferedReader stdIn = new BufferedReader(new InputStreamReader(System.in));
  ...
  public static void selectProducts(Product cart[], Product products[]) throws IOException //Part of the Selling Module, Selects Products for a Client to Buy Them
  {
    PrintWriter stdOut = new PrintWriter(System.out, true);
    BufferedReader stdIn = new BufferedReader(new InputStreamReader(System.in));
  ...
  public static Product[] fillArrayProducts(Product[] products, File inventory) throws IOException //Reads Inventory File
  {
  ...
  public static Client[] fillArrayClients(Client[] clients, File database) throws IOException //Reads Database File
  {
  ...
  public static void saveFileProducts(Product products[], File inventory) throws IOException //Writes Inventory File
  {
  ...
  public static void saveFileClients(Client clients[], File database) throws IOException //Writes Database File
  {
  ...
  public static int clientsInfo(Client clients[], String username) throws IOException //Client Information Form for Selling
  {
    PrintWriter stdOut = new PrintWriter(System.out, true);
    BufferedReader stdIn = new BufferedReader(new InputStreamReader(System.in));
  ...
  public static void sell(Product cart[], Client clients[], int i) throws IOException //Payment Method of the Selling Module
  {
    Calendar today = Calendar.getInstance();
    PrintWriter stdOut = new PrintWriter(System.out, true);
    BufferedReader stdIn = new BufferedReader(new InputStreamReader(System.in));
  ...
  public static void printing(Client clients[], Product products[], int i) throws IOException //Generates Text File (Local Invoice)
  {
    Calendar today = Calendar.getInstance();
  ...
  public static String starsLarge(int length) //Decoration Stars
  {
    String out = "";
  ...
  public static String starsSide() //Decoration Stars
  {
    String a;
    a="*";
    return a;
  ...
  public static boolean analyzeRFC(String rfc, int noteType) //Validates Information of RFC in the Selling Module
  {
